...
export const clockWidget: WidgetDefinition<ClockSettings> = {
  ...
  minSize: { w: 180, h: 90 },
  settingsSchema: [
    { key: "digitStyle", label: "시계 스타일", type: "select", default: "blocks",
      options: [
        { value: "blocks", label: "사각 블록 (디지털)" },
        { value: "neon", label: "네온 (글로우)" },
        { value: "matrix", label: "도트 매트릭스 (LED)" },
        { value: "dots", label: "도트 매트릭스 (문자)" },
        { value: "system", label: "시스템 폰트" },
        { value: "word", label: "워드 클락 (5분 단위)" },
        { value: "binary", label: "바이너리 (2진수)" },
        { value: "fibonacci", label: "피보나치 (5분 단위)" },
      ] },
    { key: "blockColor", label: "시계 색 (비우면 강조색)", type: "text", default: "", placeholder: "#4fd1c5" },
    { key: "glow", label: "네온 글로우 세기", type: "number", default: 60, min: 0, max: 100, step: 10 },
    { key: "wordLang", label: "워드 클락 언어", type: "select", default: "en",
      options: [
        { value: "en", label: "English — IT IS HALF PAST TEN" },
        { value: "ko", label: "한국어 — 지금은 열시 삼십분" },
      ] },
    { key: "dotChar", label: "도트 문자 (문자 도트용)", type: "text", default: "■", placeholder: "■ 🟦 ⬜ ●" },
